...
public class AppTest {
    ...
    public void JDBCDemo1() throws ClassNotFoundException, SQLException {
        ...
        //3.获取数据库连接对象
        Connection connection = DriverManager.getConnection("jdbc:mysql://10.211.55.18:3306/crm", "admin", "123456");
        //4.定义SQL语句
    ...
    public void JDBCDemo2() {
        ...
        try {
            ...
            //3.获取数据库连接对象
            connection = DriverManager.getConnection("jdbc:mysql://10.211.55.18:3306/crm", "admin", "123456");
            //4.定义SQL语句
